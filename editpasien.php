                ...
                ?>
                    <form action="koneksi.php" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="idPasien" palceholder="ID Pasien" value="<?= $row['idPasien'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="nmPasien">Nama Pasien</label>
                            <input type="text" class="form-control mb-3" name="nmPasien" placeholder="Nama Pasien" value="<?= $row['nmPasein'] ?>">
                        </div>
                        <div class="form-group">
